...
public partial class @CameraController: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""CameraControls"",
            ""id"": ""486c5bf0-c36f-4807-8f04-f07bd3ac281c"",
            ""actions"": [
                {
                    ""name"": ""MouseZoom"",
                    ""type"": ""Value"",
                    ""id"": ""64cdc693-5ae3-423b-b9d0-242e74ea7a33"",
                ...
                },
                {
                    ""name"": ""GamepadZoom"",
                    ""type"": ""Value"",
                    ""id"": ""577248e5-c8b5-4b3e-b58d-8fb9ce7bf639"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""93eafcd4-11c2-475e-9c70-9cad206fd74a"",
                    ""path"": ""<Mouse>/scroll"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""982e8f2e-f9b2-4335-8a9e-76f9a6dcbf50"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""89c7e564-cf3d-4c9f-8375-2d615a0fbb58"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""31a06427-95bc-4bf0-8843-cd010054f131"",
    ...
    ~@CameraController()
    {
        UnityEngine.Debug.Assert(!m_CameraControls.enabled, "This will cause a leak and performance issues, CameraController.CameraControls.Disable() has not been called.");
    }
